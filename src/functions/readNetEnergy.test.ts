...
test('read a csv containg net energy entries with an other date format', () => {
    const expecteds: DateNetEnergy[] = [
        new DateNetEnergy(new Date("2024-05-17T18:15:00.000Z"), new NetEnergy(159, 69, 90, 0, 0, 0, 0)),
        new DateNetEnergy(new Date("2024-05-17T18:30:00.000Z"), new NetEnergy(199, 241, 0, 42, 0, 0, 0))]
